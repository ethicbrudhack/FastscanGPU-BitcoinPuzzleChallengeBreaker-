...
- ✅ **Up to 2.0 GH/s** — on RTX 4090 with optimized kernel and 24‑bit index  
...
| **FastScan GPU** | GTable + point additions | **Up to 2.0 GH/s** | ✅ 100% | ✅ Handles |

**FastScan GPU is 50–100× faster than KeyHunt/BitCrack** and up to **2.0 GH/s** on RTX 4090.
...
| Hardware | Speed |
|----------|-------|
| **NVIDIA RTX 4090** | **Up to 2.0 GH/s** |
| **NVIDIA RTX 4080** | ~1.2–1.5 GH/s |
| **NVIDIA RTX 3090** | ~0.8–1.0 GH/s |
| **NVIDIA RTX 3080** | ~0.5–0.7 GH/s |

**2.0 GH/s = 2 billion keys per second** – you can scan a 2⁶⁰ range in just a few hours.
