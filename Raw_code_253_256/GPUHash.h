...
// OPTYMALIZACJA: __funnelshift_r(x,x,n) = rotacja w prawo o n bitow
// realizowana JEDNA sprzetowa instrukcja SHF (Ada/Ampere) zamiast
// 2 shiftow + OR. Wynik bitowo identyczny z ((x>>n)|(x<<(32-n))).
...
// OPTYMALIZACJA: rotacja w lewo o n bitow jedna instrukcja SHF.
